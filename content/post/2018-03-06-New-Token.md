...
// process.env.ROPSTEN_MNEMONIC: metamask.io 登録時の12 wordsを記載。
...
truffle(live)> token.balanceOf("0x75d06aef44c47ed72d26cb1038727299653a2307")
BigNumber { s: 1, e: 24, c: [ 10000000000 ] }
truffle(live)>
```
...
gethでlive環境に接続して数十GBのノード同期してそれに対してデプロイしても同じ結果になると思います。（実際試してないですが）
